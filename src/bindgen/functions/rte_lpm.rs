...
extern "C"
{
	pub fn rte_lpm6_add(lpm: *mut rte_lpm6, ip: *mut uint8_t, depth: uint8_t, next_hop: uint32_t) -> c_int;
	pub fn rte_lpm6_add_v1705(lpm: *mut rte_lpm6, ip: *mut uint8_t, depth: uint8_t, next_hop: uint32_t) -> c_int;
	pub fn rte_lpm6_add_v20(lpm: *mut rte_lpm6, ip: *mut uint8_t, depth: uint8_t, next_hop: uint8_t) -> c_int;
	...
	pub fn rte_lpm6_is_rule_present(lpm: *mut rte_lpm6, ip: *mut uint8_t, depth: uint8_t, next_hop: *mut uint32_t) -> c_int;
	pub fn rte_lpm6_is_rule_present_v1705(lpm: *mut rte_lpm6, ip: *mut uint8_t, depth: uint8_t, next_hop: *mut uint32_t) -> c_int;
	pub fn rte_lpm6_is_rule_present_v20(lpm: *mut rte_lpm6, ip: *mut uint8_t, depth: uint8_t, next_hop: *mut uint8_t) -> c_int;
	pub fn rte_lpm6_lookup(lpm: *const rte_lpm6, ip: *mut uint8_t, next_hop: *mut uint32_t) -> c_int;
	pub fn rte_lpm6_lookup_bulk_func(lpm: *const rte_lpm6, ips: *mut [uint8_t; 16usize], next_hops: *mut int32_t, n: c_uint) -> c_int;
	pub fn rte_lpm6_lookup_bulk_func_v1705(lpm: *const rte_lpm6, ips: *mut [uint8_t; 16usize], next_hops: *mut int32_t, n: c_uint) -> c_int;
	pub fn rte_lpm6_lookup_bulk_func_v20(lpm: *const rte_lpm6, ips: *mut [uint8_t; 16usize], next_hops: *mut int16_t, n: c_uint) -> c_int;
	pub fn rte_lpm6_lookup_v1705(lpm: *const rte_lpm6, ip: *mut uint8_t, next_hop: *mut uint32_t) -> c_int;
	pub fn rte_lpm6_lookup_v20(lpm: *const rte_lpm6, ip: *mut uint8_t, next_hop: *mut uint8_t) -> c_int;
