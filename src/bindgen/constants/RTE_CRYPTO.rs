...
pub const RTE_CRYPTODEV_FF_CPU_ARM_CE: c_int = 2048;
pub const RTE_CRYPTODEV_FF_CPU_AVX2: c_int = 32;
pub const RTE_CRYPTODEV_FF_CPU_AVX512: c_int = 256;
pub const RTE_CRYPTODEV_FF_CPU_AVX: c_int = 16;
pub const RTE_CRYPTODEV_FF_CPU_NEON: c_int = 1024;
pub const RTE_CRYPTODEV_FF_CPU_SSE: c_int = 8;
pub const RTE_CRYPTODEV_FF_HW_ACCELERATED: c_int = 128;
pub const RTE_CRYPTODEV_FF_MBUF_SCATTER_GATHER: c_int = 512;
