...
pub const RTE_LIBRTE_EFD: c_int = 1;
...
pub const RTE_LIBRTE_I40E_16BYTE_RX_DESC: c_int = 1;
pub const RTE_LIBRTE_I40E_INC_VECTOR: c_int = 1;
pub const RTE_LIBRTE_I40E_ITR_INTERVAL: c_int = 16;
...
pub const RTE_LIBRTE_NFP_PMD: c_int = 1;
