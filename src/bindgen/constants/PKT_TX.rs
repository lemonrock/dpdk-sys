...
pub const PKT_TX_MACSEC: c_longlong = 17592186044416;
pub const PKT_TX_OFFLOAD_MASK: c_longlong = 468356769060487168;
...
pub const PKT_TX_TUNNEL_GENEVE: c_longlong = 140737488355328;
pub const PKT_TX_TUNNEL_GRE: c_longlong = 70368744177664;
pub const PKT_TX_TUNNEL_IPIP: c_longlong = 105553116266496;
pub const PKT_TX_TUNNEL_MASK: c_longlong = 527765581332480;
pub const PKT_TX_TUNNEL_VXLAN: c_longlong = 35184372088832;
